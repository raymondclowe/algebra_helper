...
class QuestionValidator {
    ...
    async initialize() {
        ...
        console.log('✅ Screenshot generator initialized (using live app with URL parameters)\n');
    }
    ...
    async validateQuestionType(level, topic, questionType) {
        console.log(`📝 Validating Level ${level} (${topic}) - Type ${questionType}...`);
        ...
        try {
            ...
            if (!questionData) {
                console.log(`   ⚠️ No question data extracted`);
                return {
                    success: false,
            ...
            console.log(`   🤖 Sending to Gemini 3 Pro for validation...`);
            ...
            console.log(`   💾 AI response saved for cross-checking`);
            ...
            if (validation.needsReview) {
                ...
                console.log(`   📄 Issue file created: ${path.basename(issueFile)}`);
            }
     ...
     */
    async validateAll() {
        console.log('🎯 Starting validation of all question types...\n');
        ...
        console.log(`\n📊 Testing ${totalTypes} question types across ${config.levelsToTest.length} levels\n`);
    ...
    async generateReport() {
        ...
        if (invalidQuestions.length > 0) {
            ...
            console.log(`\n📂 Issue files saved to: ${config.issuesDir}/\n`);
        } else {
