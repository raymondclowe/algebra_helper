...
window.ExplanationModal = {
    ...
    show: function(explanation, allowRetry = true, detailedExplanation = '') {
        ...
        const processedExplanation = window.GeneratorUtils?.processTextContent(explanation) || explanation;
    ...
    generateDetailedExplanation: function(question) {
        ...
        const processedBasicExplanation = window.GeneratorUtils?.processTextContent(basicExplanation) || basicExplanation;
        detailed += `<div class="bg-gray-700 p-3 rounded">`;
